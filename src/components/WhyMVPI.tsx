              ...
              >
                ...
                <div
                  className={`hidden lg:flex items-center absolute top-1/2 -translate-y-1/2 ${
                    index % 2 === 0 ? "left-full" : "right-full flex-row-reverse"
                  }`}
                  style={{ width: "calc((100% / 0.42) * 0.08 + 8px)" }}
                >
                  <div className="flex-1 h-px bg-[#BFA054]/30 relative overflow-hidden">
                    <motion.div
                      ...
                      animate={{ width: ["0%", "100%"], opacity: [0.8, 0] }}
                      transition={{ duration: 1.5, repeat: Infinity, ease: "easeOut", delay: index * 0.4 }}
                    />
                  </div>
                  <motion.div
