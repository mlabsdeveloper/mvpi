...
const areaImages: Record<(typeof areaIds)[number], string> = {
  "01": "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1920&q=80",
  "02": "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1920&q=80",
  "03": "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1920&q=80",
  "04": "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=1920&q=80",
};
...
export default function ExpertisePage() {
  ...
  const expertiseAreas = areaIds.map((id) => ({
    ...
    tagline: t(`areas.${id}.tagline`),
    description: t(`areas.${id}.description`),
    capabilities: t.raw(`areas.${id}.capabilities`) as Capability[],
    outcomes: t.raw(`areas.${id}.outcomes`) as string[],
    image: areaImages[id],
  }));
